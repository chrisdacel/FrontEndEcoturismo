...
export default function Header() {
  ...
  return (
    <header
      /* Sticky header troubleshooting: Ensure parent containers do NOT have overflow:hidden or transform. */
      className={
        isAuthPage
          ? 'absolute top-0 left-0 right-0 z-[100] w-full bg-transparent'
          : `sticky top-0 z-[100] w-full transition backdrop-blur supports-[backdrop-filter]:bg-white/5 bg-white/5 ${isColeccionPage ? '' : 'ring-1 ring-white/10'}`
      }
    >
